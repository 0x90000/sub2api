...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	windsurfModelCatalogService := service.NewWindsurfModelCatalogService()
	windsurfErrorMapper := service.NewWindsurfErrorMapper()
	windsurfGatewayService := service.NewWindsurfGatewayService(windsurfAccountProbeService, windsurfModelCatalogService, windsurfUsageFetcher, windsurfErrorMapper)
